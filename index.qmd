  ...
  <div class="gallery-wrapper">
    ...
    <div class="gallery-slider">
      ...
      <div class="gallery-slide">
        ...
        long nine-hour drive from Bozeman to Denver. The road felt long, 
        but the time together made it special.</p>
      </div>
   
     <div class="gallery-slide">
        <img src="assets/images/nash.jpg" alt="">
        <p>This photo was taken on a hotel rooftop with the Nashville
        skyline behind us. It was a nice break from the busy schedule.</p>
      </div>
      
      <div class="gallery-slide">
        <img src="assets/images/GoM.jpg" alt="">
        <p>This photo was taken on the Missouri River at the Gates of the
        Mountains in Helena, Montana. It was such a peaceful day, just 
        being out on the water and enjoying the scenery. </p>
      </div>
